...
public class Protocol {
    ...
    public static final String USER_CHANGE_NICKNAME = "/user_change-login";

    public static String getUserBroadcast(String msg) {
        return USER_BROADCAST + DELIMITER + msg;
    }

    public static String getUserChangeNickname(String msg) {
        return USER_CHANGE_NICKNAME + DELIMITER + msg;
    }
